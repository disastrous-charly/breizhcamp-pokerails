...
class TownsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create town" do
    assert_difference('Town.count') do
      post towns_url, params: { town: { name: @town.name } }
    end

    assert_redirected_to town_path(Town.last)
  end
  ...
  test "should update town" do
    patch town_url(@town), params: { town: { name: @town.name } }
    assert_redirected_to town_path(@town)
  end
