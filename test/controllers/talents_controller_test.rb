...
class TalentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create talent" do
    assert_difference('Talent.count') do
      post talents_url, params: { talent: { created_at: @talent.created_at, name: @talent.name } }
    end

    assert_redirected_to talent_path(Talent.last)
  end
  ...
  test "should update talent" do
    patch talent_url(@talent), params: { talent: { created_at: @talent.created_at, name: @talent.name } }
    assert_redirected_to talent_path(@talent)
  end
